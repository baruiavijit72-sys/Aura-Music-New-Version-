...
export const HomeView: React.FC<HomeViewProps> = ({
  ...
  return (
    <div className="space-y-6 pb-28 text-white select-none">
              ...
              <div className="flex items-center gap-2.5 min-w-0">
                ...
                >
                  {getSongCoverUrl(track) ? (
                    <img src={getSongCoverUrl(track)} alt="" className="w-full h-full object-cover" />
                  ) : (
      ...
      {/* Online Sponsored Ad (Facebook / YouTube / Instagram style) */}
      <RealAdBanner slotIndex={1} format="feed" />
        ...
        <div className="flex gap-3 overflow-x-auto no-scrollbar pb-2">
          {recentlyPlayedTracks.map((track) => (
            ...
            >
              ...
              >
                {getSongCoverUrl(track) ? (
                  <img src={getSongCoverUrl(track)} alt="" className="w-full h-full object-cover group-hover:scale-105 transition duration-300" />
                ) : (
                  <div className="w-full h-full flex items-center justify-center text-white/50">
                    <Music2 className="w-10 h-10" />
                  </div>
